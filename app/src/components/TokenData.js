                  ...
                  return (
                    {
                      ...
                      auctionExpiry: groomBlocks((parseInt(item.startBlock) + parseInt(item.auctionLength)).toString(), this.props.currentBlock),
                      auctionPrice: groomValues(getPrice(item.startBlock,
                          item.auctionLength,
                          item.startPrice,
                          item.priceStep,
                          item.timeStep,
